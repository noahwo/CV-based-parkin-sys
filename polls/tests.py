...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        ...
        self.assertIs(
            ...
            "The future message was regarded as published recently.")
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        self.assertIs(
            ...
            "The question  older than one day was regarded as published recently."
        )
    ...
    def test_was_publised_recently_with_recent_question(self):
        ...
        self.assertIs(
            ...
            "The question published within one day was not regarded as published recently"
        )
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_no_questions(self):
        """
        If no questions exist, anapproriate message is displayed.
        """
    ...
    def test_two_past_questions(self):
        ...
        response=self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'],[question2, question],) 
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        url=reverse('polls:deatial',args=(past_question.id,))
        response=self.client.get(url)
